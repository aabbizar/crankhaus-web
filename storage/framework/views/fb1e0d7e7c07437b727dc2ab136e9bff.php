...
<head>
    ...
    <title>Login — <?php echo e(config('app.name', 'Crankhaus')); ?></title>
...
<?php endif; ?>
    ...
    <div class="ck-login-card" id="ckCard">
        ...
        <div class="ck-left" aria-hidden="true">
            <img
                src="<?php echo e(asset('images/login_hero_cafe.png')); ?>"
        ...
        <div class="ck-right" id="ckRight">
            ...
            <a href="<?php echo e(route('home')); ?>" class="ck-back" id="ckBack" aria-label="Back to homepage">
...
<?php /**PATH C:\laragon\www\agtokosahaja_project\resources\views/layouts/guest.blade.php ENDPATH**/ ?>