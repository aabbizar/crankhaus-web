        ...
        <section class="w-full min-h-screen flex flex-col items-center justify-center py-20 px-6 text-center gsap-3d-reveal bg-[#b42638] relative z-10">
            <div class="w-full max-w-screen-xl mx-auto flex flex-col items-center text-center">
                ...
                <div class="flex flex-col md:flex-row gap-12 md:gap-4 items-stretch justify-center w-full max-w-3xl">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['Fill in the form', 'Confirmed within 2 hours', 'Arrive & reload']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="flex flex-col items-center text-center flex-1 relative px-4">
                        ...
                        <div class="w-16 h-16 rounded-full flex items-center justify-center font-display font-black text-xl mb-6 shadow-[4px_4px_0px_0px_#020b0a] border-[3px] border-[#020b0a] transition-transform hover:scale-110 duration-200"
                             style="background: <?php echo e(['#eba13d', '#ffffff', '#020b0a'][$i]); ?>; color: <?php echo e(['#020b0a', '#b42638', '#eba13d'][$i]); ?>;">
                            <?php echo e($i + 1); ?>

                        </div>
                        <span class="font-display text-sm text-[#efe1d9] uppercase tracking-wider font-extrabold max-w-[200px] leading-snug"><?php echo e($step); ?></span>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3666066824-0', $__key);
...
?>
    ...
    <?php if (isset($component)) { $__componentOriginale496872507133d1e853957bdaf65469d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale496872507133d1e853957bdaf65469d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-transitions','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('page-transitions'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale496872507133d1e853957bdaf65469d)): ?>
<?php $attributes = $__attributesOriginale496872507133d1e853957bdaf65469d; ?>
<?php unset($__attributesOriginale496872507133d1e853957bdaf65469d); ?>
<?php endif; ?>
<?php if (isset($__componentOriginale496872507133d1e853957bdaf65469d)): ?>
<?php $component = $__componentOriginale496872507133d1e853957bdaf65469d; ?>
<?php unset($__componentOriginale496872507133d1e853957bdaf65469d); ?>
<?php endif; ?>
...
<?php /**PATH C:\laragon\www\agtokosahaja_project\resources\views/reserve.blade.php ENDPATH**/ ?>