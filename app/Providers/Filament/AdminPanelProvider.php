...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            // Filament native default colors — no custom override
            ->brandName('Crankhaus Admin')
            ...
            ->widgets([
                ...
                \App\Filament\Widgets\StockChart::class,
            ])
            ->navigationItems([
                NavigationItem::make('← View Frontend')
            ...
            // ── BODY_END: GSAP toast + polling for new orders/reservations ──────
            // NOTE: No HEAD_END override so Filament uses its own native CSS/JS.
            ->renderHook(
                PanelsRenderHook::FOOTER,
                fn (): string => Blade::render(<<<'BLADE'
                    {{-- ── FOOTER (Background Image - Fixed Perfect Size - Brighter Overlay) ── --}}
                    <footer style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('{{ asset('images/footerfix.jpg') }}') center/cover no-repeat; padding: 16px 10px; width: 100%; border-top: 1px solid rgba(255,255,255,0.05); display: flex; justify-content: center; align-items: center; margin-top: 40px; border-radius: 12px; overflow: hidden;">
                        <div class="w-full max-w-screen-2xl mx-auto flex justify-center items-center px-4">
                            <a href="/" style="text-decoration: none; color: white; transition: opacity 0.3s;" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'">
                                <div class="font-display" style="font-weight: 900; line-height: 0.85; letter-spacing: 0.02em; text-align: center; font-family: 'Space Grotesk', sans-serif;">
