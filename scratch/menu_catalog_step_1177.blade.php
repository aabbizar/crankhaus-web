Created At: 2026-05-25T18:04:29Z
Completed At: 2026-05-25T18:04:29Z
...
26:     </div>
27: 
28:     {{-- ══ MENU GRID (MINIMAL MASONRY) ═════════════════════════════════════ --}}
29:     <div class="columns-2 sm:columns-3 lg:columns-4 xl:columns-5 gap-6 sp
<truncated 23510 bytes>
...
439:             gsap.fromTo('.ck-menu-card',
440:                 { y: 60, opacity: 0, scale: 0.95 },
441:                 {
442:                     y: 0, opacity: 1, scale: 1, duration: 0.8, stagger: 0.05, ease: 'power4.out',
443:                     scrollTrigger: { trigger: '#menuGrid', start: 'top 90%' }
444:                 }
445:             );
446:         }
447:     };
